<script module>
  // SSE primitives absorbed from live-events.js (Svelte migration teardown).
  // Exported so their unit tests drive them directly; the instance onMount
  // below calls them.
  // ── live-events ───────────────────────────────────────────────────────────
...
<script>
  ...
  // SSE primitives remain in the <script module> above (exported for their unit
  // tests). Follow-scroll, stats, and chat-preview helpers live in session/live/
  // modules.
